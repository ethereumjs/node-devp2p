...
var Peer = exports = module.exports = function(socket, network, id) {
  ...
  this.eciesSession = new ECIES(
    ...
    Buffer.concat([new Buffer([4]), this.id]) //remote public key
  );
  ...
  switch (this.state) {
    ...
    case 'Body':
      ...
      if (type[0] < 0x10 || type[0] === 0x80) {
        ...
        console.log('not base package');
        console.log('type: ' + type.toString('hex'));
