...
var ECIES = module.exports = function (secKey, pubKey, remotePubKey) {
  ...
  this.ephemeralPubKey = secp256k1.publicKeyCreate(this.ephemeralSecKey, false)
...
ECIES.prototype.encryptMessage = function (secKey, data) {
  ...
  var ourPubKey = secp256k1.publicKeyCreate(secKey, false)
...
ECIES.prototype.parseAuth = function (data) {
  ...
  var r = ECIES.ecdh(this.secKey, pubKey)
  var ephemeral = this.remoteEphemeralPubKey = secp256k1.recover(xor(r, nonce), signature, recId[0], false).slice(1)
...
ECIES.prototype.createAuth = function () {
  ...
  var sigr = secp256k1.sign(xor(r, this.nonce), this.ephemeralSecKey)
  var ephemeralPubKey = secp256k1.publicKeyCreate(this.ephemeralSecKey, false).slice(1)
